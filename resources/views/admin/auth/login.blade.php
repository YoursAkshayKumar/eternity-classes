@extends('admin.partials.layouts.master-auth')

@section('title', 'Sign In | Eternity Classes')

@section('css')
@include('admin.partials.head-css', ['auth' => 'layout-auth'])
@endsection
...
<div class="account-pages">
    <img src="{{ asset('assets/admin/images/auth/auth_bg.jpeg') }}" alt="auth_bg" class="auth-bg light">
    <img src="{{ asset('assets/admin/images/auth/auth_bg_dark.jpg') }}" alt="auth_bg_dark" class="auth-bg dark">
    <div class="container">
            ...
            <div class="col-lg-6">
                <div class="auth-box card card-body m-0 h-100 border-0 justify-content-center">
                    <div class="mb-5 text-center">
                        ...
                        <h4 class="fw-normal">Welcome to <br><span class="fw-bold text-primary">Eternity Classes</span></h4>
                    </div>
                    <form class="form-custom mt-10" role="form" id="formLogin" name="formLogin" action="{{ url('admin/login') }}" method="post">
